...
export async function up(db: Kysely<any>): Promise<void> {
  // Add Nano ID
  // (Taken from https://github.com/viascom/nanoid-postgres)
  // Modified by:
  //   - Replacing default alphabet with 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz (removed special chars)
  //   - Decreasing the size from 21 to 16
  //   - Recalculating additional bytes factor to 1.02 (see https://github.com/viascom/nanoid-postgres?tab=readme-ov-file#calculating-the-additional-bytes-factor-for-a-custom-alphabet)
  //
